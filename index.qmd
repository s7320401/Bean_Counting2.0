...
Decoding customer behavior through Visual Analytics. <br>
...
<h2 style="margin: 0; border: none;">The Art of Data Brewing: From Seed to Sip</h2>
</div>
...
<h3 class="single-line-title">Harvesting Insight</h3>
<p class="intro-subtitle">Analysing Spending Behaviours</p>
<p class="card-body-text">Just as harvesting ripe cherries is the foundation of quality, understanding transaction frequency and volume serves as our "origin" data.</p>
:::

::: {.g-col-12 .g-col-md-4 .intro-card}
<img src="pic2.png" class="intro-icon" style="width: 170px; height: 85px; margin-bottom: 15px;">
<h3 class="single-line-title">Grading the Roast</h3>
<p class="intro-subtitle">Comparing Occupations</p>
<p class="card-body-text">Green beans must be meticulously graded. We treat "Occupation" as a critical grading metric to identify "premium segments."</p>
:::

::: {.g-col-12 .g-col-md-4 .intro-card}
<img src="pic3.png" class="intro-icon" style="width: 100px; height: 85px; margin-bottom: 15px;">
<h3 class="single-line-title">The Final Cupping</h3>
<p class="intro-subtitle">Churn Probability Prediction</p>
<p class="card-body-text">Predicting churn is like cupping for defects. Using predictive modeling, we act as a quality control layer to ensure relationships remain bold.</p>
:::
...
::: {#shiny-app .content-section .column-screen style="padding: 25px 5%; background-color: #FDF5E6;"}
<div class="shiny-placeholder">
### 📊 RShiny App: Interactive Dashboard Coming Soon
*Experience the brewing process through real-time data exploration.*
</div>
:::
...
<h2 style="border: none;">🖼️ Project Poster</h2>
</div>

<div style="max-width: 1000px; margin: 0 auto; box-shadow: 0 10px 30px rgba(0,0,0,0.1); border-radius: 10px; overflow: hidden; background: white;">
<img src="poster.png" alt="Project Poster" style="width: 100%; height: auto; display: block;">
<div style="padding: 20px; text-align: center; background: #3C2A21;">
...
<div class="proto-header-content">
<h2 style="border: none;"> Prototypes</h2>
<p>Explore our data refinery process, from raw sorting to the final predictive brew.</p>
</div>

<div class="prototype-slider">

<div class="proto-card">
<div class="proto-img-wrapper">
<div class="proto-number">01</div>
...
<p class="proto-tag">Data Preparation</p>
<h4>Cleaning the Beans</h4>
<p>Filtering and structuring data to ensure every observation meets our quality standards.</p>
</div>
</div>

<div class="proto-card">
<div class="proto-img-wrapper">
<div class="proto-number">02</div>
...
<div class="proto-info">
<p class="proto-tag">Exploratory Analysis</p>
...
<div class="proto-info">
<p class="proto-tag">Confirmative Analysis</p>
...
<div class="proto-info">
<p class="proto-tag">Clustering Analysis</p>
...
<div class="proto-info">
<p class="proto-tag">Decision Tree</p>
...
<h2 style="color: #EDE0D4; border: none; margin-bottom: 30px;">☕ Contact Us</h2>
::: {.grid}
::: {.g-col-12 .g-col-md-4}
#### **DODDAPANENI Virinchi**
