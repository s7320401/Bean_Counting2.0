...
:::: {#shiny-app .column-screen style="background: linear-gradient(rgba(60, 42, 33, 0.8), rgba(60, 42, 33, 0.8)), url('shinyappbac.png') no-repeat center center; background-size: cover; min-height: 80vh; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; color: #FDF5E6; padding: 100px 20px;"}

## RShiny App

### UNDERSTAND THE SPENDING NATURE OF CUSTOMERS

Experience our comprehensive visual analytics platform for the **Bean Counting 2.0** project. 
Explore customer segments, analyze spending behaviors, and predict churn risks through our real-time interactive dashboard.

<br>

[Explore the Analytics Dashboard](https://coop3r0401.shinyapps.io/DashBoard/){.btn .btn-outline-light .btn-lg role="button" target="_blank"}
...
<img src="Visual Poster.jpg" alt="Project Poster" style="width: 100%; height: auto; display: block;"/>

::: {style="padding: 20px; text-align: center; background: #3C2A21;"}
<a href="Visual Poster.jpg" class="btn btn-outline-light" target="_blank">Download Poster </a>
:::
::::
::::::
...
.prototype-hero-section {
  padding: 100px 5%;
  /* 把這裡的 'coffee-bg2.png' 換成你想要的圖片名稱 */
  background: linear-gradient(rgba(60, 42, 33, 0.75), rgba(60, 42, 33, 0.75)), 
